...
> **Language note:** This document, the main README, and all **inline source code comments** are written in **English**.
> Historical session logs in `CHANGELOG.md` remain in **Spanish** matching the companion Python dashboard project.
